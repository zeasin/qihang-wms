...
public class TaoOrderApiController {
    ...
    @ResponseBody
    public AjaxResult pullIncrementOrder(@RequestBody PullRequest req) throws IOException {
        log.info("/**************增量拉取tao订单****************/");
...
//        ApiResultVo<TaoOrderResponse> upResult = OrderApiHelper.pullIncrementOrder(startTime,endTime,pageIndex, pageSize, url, appKey, appSecret, sessionKey);
    ...
    @ResponseBody
    public AjaxResult getOrderPullDetail(@RequestBody PullRequest taoRequest) throws IOException {
